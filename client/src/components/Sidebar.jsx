...
const NAV_ITEMS = [
  ...
  { name: 'Disaster Zones', path: '/zones', icon: AlertTriangle },
  ...
  return (
    <aside className="w-64 bg-[#030712]/90 backdrop-blur-2xl border-r border-white/10 flex flex-col justify-between shrink-0 h-[calc(100vh-4rem)] sticky top-16 select-none shadow-[8px_0_32px_0_rgba(0,0,0,0.8)]">
      ...
      <div className="p-4 border-t border-white/10">
        <div className="p-3.5 cyber-card rounded-2xl space-y-2 text-xs">
          <div className="flex items-center justify-between text-[#F8FAFC] font-bold font-mono">
            ...
            <span className="text-[10px] px-2 py-0.5 bg-[#0B0F19] text-[#10B981] rounded-md border border-[#10B981]/50 font-bold shadow-[0_0_10px_rgba(16,185,129,0.3)]">
              LIVE
            </span>
          </div>
          <p className="text-[11px] text-[#94A3B8] leading-relaxed font-mono">
            SURVER bridges Gemini AI risk evaluation with deterministic resource dispatching.
          </p>
        </div>
      </div>
    </aside>
