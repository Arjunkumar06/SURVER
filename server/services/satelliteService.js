...
function generateSvgImagery(zone, type = 'before') {
  ...
  if (type === 'before') {
    ...
    if (isFlood) {
      activeOverlay = `
        <defs>
          <radialGradient id="heatGrad_${code}" cx="45%" cy="55%" r="45%">
            <stop offset="0%" stop-color="#ef4444" stop-opacity="0.9"/>
            <stop offset="50%" stop-color="#f97316" stop-opacity="0.7"/>
            <stop offset="100%" stop-color="#0284c7" stop-opacity="0.1"/>
          </radialGradient>
        </defs>
        <ellipse cx="280" cy="220" rx="220" ry="140" fill="url(#heatGrad_${code})" stroke="#ef4444" stroke-width="2" stroke-dasharray="6,4"/>
